...
drop2_df.to_pickle('%s_ortho_dataframe'%(date.today().strftime("%d_%m_%Y")))
ratio_df.to_pickle('%s_ratio_ortho_dataframe'%(date.today().strftime("%d_%m_%Y"))) 
#ratio_df = pd.read_pickle('18_06_2024_ratio_ortho_dataframe')
